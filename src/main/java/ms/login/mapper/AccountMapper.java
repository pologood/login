...
public interface AccountMapper {
  class Sql {
    ...
    final static String ADD_OPEN_USER_BY_EMAIL = "INSERT INTO " + TABLE +
  ...
  @Insert(Sql.ADD_OPEN_USER_BY_EMAIL)
  int addOpenUserByEmail(@Param("id") long id, @Param("email") String email,
